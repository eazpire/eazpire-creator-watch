...
class WearTranslationStore(private var lang: String = "en") {
    ...
    companion object {
        private val strings = mapOf(
            ...
            "wear.pair_need_phone" to "Pair an Android phone, then install Eazpire Creator (com.eazpire.creator).",
            "wear.pair_need_phone_app" to "Install Eazpire Creator on your phone from Play Store.",
            "wear.pair_need_phone_login" to "Open the phone app and sign in — your account syncs to the watch.",
            "wear.pair_hint_line1" to "Scan with Eazpire app",
            "wear.pair_hint_line2" to "Creator Settings → Creator Wear → Connect",
